...
describe("acount service tests", () => {
  let inMemoryService = new InMemoryDBService<AccountEntity>({ featureName: 'account' })
  let accountRepository = new AccountRepository(inMemoryService);
  ...
  beforeAll(async () => {
    testModule = await Test.createTestingModule({
      providers: [
        ...
        }, AccountRepository, InMemoryDBService, HttpResponseService, AccountService
      ],
      imports: [
        CommonModule
      ],
