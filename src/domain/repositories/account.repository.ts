...
export class AccountRepository{
     ...
     */
    constructor(private readonly accountService: InMemoryDBService<AccountEntity>){
    }
    //=======================================================================================================
    /**
     ...
     */
    async create(record:AccountEntity):Promise<Observable<AccountEntity | AccountEntity[]>>{
     ...
     * @returns Promise<Observable<AccountEntity | AccountEntity[]>>
     */
    async get(id:string):Promise<Observable<AccountEntity | AccountEntity[]>>{
